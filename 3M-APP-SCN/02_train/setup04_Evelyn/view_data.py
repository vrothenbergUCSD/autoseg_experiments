...
# aws_external = 'ec2-34-210-119-207.us-west-2.compute.amazonaws.com'
# aws_internal = 'ip-172-31-15-115.us-west-2.compute.internal'

# url = viewer.get_viewer_url()
# # print(url)
# new_url = "localhost:8080/" + url.split(":8080/")[-1]
# print(new_url)
print(viewer)
