...
def parse_arguments():
    ...
    parser.add_argument('--threshold', default=10, type=int, help='Threshold for filtering (default: 5)')
...
if __name__ == "__main__":
    try:
        ...
        start = time.time()
        command = f"""python filter_counts.py --input_zarr {args.input_zarr} \
    ...
    #     # Run remap_ids.py
    #     start = time.time()
    #     command = f"""python remap_ids.py --input_zarr {output_zarr} \
